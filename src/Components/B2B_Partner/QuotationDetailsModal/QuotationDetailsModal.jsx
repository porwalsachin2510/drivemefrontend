                    ...
                    <div key={index} className="breakdown-card">
                      ...
                      <div className="breakdown-details">
                        <div className="breakdown-row">
                          <span>Base Rate:</span>
                          <span>KWD {breakdown.baseRate.toFixed(2)}</span>
                        </div>
                        {breakdown.driverCharges > 0 && (
                          <div className="breakdown-row">
                            <span>Driver Charges:</span>
                            <span>
                              KWD {breakdown.driverCharges.toFixed(2)}
                            </span>
                          </div>
                        )}
                        {breakdown.fuelCharges > 0 && (
                          <div className="breakdown-row">
                            ...
                            <span>KWD {breakdown.fuelCharges.toFixed(2)}</span>
                          </div>
                        )}
                        <div className="breakdown-row">
                          <span>Quantity:</span>
                        ...
                        <div className="breakdown-row subtotal">
                          <span>Subtotal:</span>
                          <span>KWD {breakdown.subtotal.toFixed(2)}</span>
                        </div>
                      </div>
                    </div>
                  )
